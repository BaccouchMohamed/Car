        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            <form method="post">
              ...
              <button type="submit" name="emailsubscibe" class="btn btn-block" style="border-radius: 22px">Subscribe <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </form>
        ...
        <div class="col-md-6 col-md-push-6 text-right">
          <div class="footer_widget">
            ...
            <ul>
              ...
              <li><a href="www.google.com"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
              <li><a href="www.instagram.com"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2021 CityZenCarRental</p>
        </div>
      </div>
    </div>
  </div>
