...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <select class="form-control" name="fueltype">
                  <option>Select your carte </option>
<option value="Biat">Biat</option>
<option value="BH">BH</option>
<option value="ATB">ATB</option>
                </select><br>
                <input type="text" name="code" placeholder="bank code">
              </div>
            
                
             
              <div class="form-group">
                <button type="submit" class="btn btn-block" style="border-radius: 22px"><i aria-hidden="true"></i> Pay</button>
              </div>
...
<input name="Submit2" type="submit" class="btn btn-success"  value="Print" onClick="return f3();" style="cursor: pointer; border-radius: 22px "  value="Print"  />
