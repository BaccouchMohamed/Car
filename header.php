    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logo.jpg"width="60px" height="60px" alt="image"/></a> </div>
        </div>
...
?>   
   ...
   <?php   if(strlen($_SESSION['login'])==0)
	{	
?>
 <div class="login_btn" > <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal" style="border-radius: 22px">Login / Register</a> </div>
<?php }
else{ 

echo "Welcome To CityZenCarRental ";
 } ?>
          </div>
        </div>
      </div>
